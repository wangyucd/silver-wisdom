...
CREATE TABLE `user_interest_tag` (
  ...
  CONSTRAINT `fk_user_interest_tag_user_id` FOREIGN KEY (`user_id`) REFERENCES `user_account` (`id`)
...
CREATE TABLE `user_status_log` (
  ...
  KEY `idx_operator_created` (`operator_admin_id`, `created_at` DESC),
  CONSTRAINT `fk_user_status_log_user_id` FOREIGN KEY (`user_id`) REFERENCES `user_account` (`id`),
  CONSTRAINT `fk_user_status_log_admin_id` FOREIGN KEY (`operator_admin_id`) REFERENCES `admin_account` (`id`)
...
CREATE TABLE `hotspot` (
  ...
  CONSTRAINT `fk_hotspot_created_by` FOREIGN KEY (`created_by`) REFERENCES `admin_account` (`id`)
...
CREATE TABLE `content_item` (
  ...
  KEY `idx_created_by` (`created_by`),
  CONSTRAINT `fk_content_item_category_id` FOREIGN KEY (`category_id`) REFERENCES `category` (`id`),
  CONSTRAINT `fk_content_item_created_by` FOREIGN KEY (`created_by`) REFERENCES `admin_account` (`id`)
...
CREATE TABLE `content_tag_rel` (
  ...
  KEY `idx_tag` (`tag`),
  CONSTRAINT `fk_content_tag_rel_content_id` FOREIGN KEY (`content_id`) REFERENCES `content_item` (`id`)
...
CREATE TABLE `ai_generate_task` (
  ...
  KEY `idx_user_created` (`user_id`, `created_at` DESC),
  KEY `idx_status_created` (`status`, `created_at` DESC),
  CONSTRAINT `fk_ai_generate_task_user_id` FOREIGN KEY (`user_id`) REFERENCES `user_account` (`id`)
...
CREATE TABLE `ai_generate_result` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_task_id` (`task_id`),
  CONSTRAINT `fk_ai_generate_result_task_id` FOREIGN KEY (`task_id`) REFERENCES `ai_generate_task` (`task_id`)
...
CREATE TABLE `learn_record` (
  ...
  KEY `idx_record_type_created` (`record_type`, `created_at` DESC),
  CONSTRAINT `fk_learn_record_user_id` FOREIGN KEY (`user_id`) REFERENCES `user_account` (`id`)
